...
apt-get install --yes python-pip python-dev python-qt4 libbluetooth-dev bluez python-dbus libusb-0.1-4 libusb-1.0-0 libjpeg8-dev libffi-dev python-opencv python-zbar
